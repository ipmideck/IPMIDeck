...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "fan_write_rejected": {
        "en": "Fan command rejected by the BMC",
        "de": "Lüfterbefehl vom BMC abgelehnt",
        "fr": "Commande de ventilateur rejetée par le BMC",
        "es": "Comando de ventilador rechazado por el BMC",
        "it": "Comando ventola rifiutato dal BMC",
        "pt": "Comando de ventilador rejeitado pelo BMC",
        "nl": "Ventilatoropdracht geweigerd door de BMC",
        "ru": "Команда вентилятора отклонена BMC",
        "pl": "Polecenie wentylatora odrzucone przez BMC",
        "zh-Hans": "BMC 拒绝了风扇命令",
        "ja": "ファンコマンドが BMC によって拒否されました",
        "ko": "BMC가 팬 명령을 거부했습니다",
    },
    "module_not_found": {
        "en": "Module not found",
